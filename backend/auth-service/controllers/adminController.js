...
//Create a new restaurant admin or delivery personnel account
  ...
  try {
    ...
    if (userType === "customer") {
      return res.status(403).json({
        success: false,
        message:
          "Customer accounts cannot be created by admins. Customers should register through the public registration page.",
      });
    }
...
exports.getUserStats = async (req, res) => {
  try {
    ...
    const deliveryPersonnel = await User.countDocuments({
