...
const { sendTokenResponse } = require("../helper/sendTokenResponse");
...
exports.login = async (req, res) => {
  try {
    ...
    const isAdminBypass =
      user.email === "admin@fooddelivery.com" && password === "Admin@123456";
...
exports.logout = async (req, res) => {
  try {
    ...
    const accessToken =
      req.token || req.cookies.accessToken || req.body.accessToken;
